...
with open('/cluster/home/ebeck/DomainGeneralisation/configs/config_class_daot.json', 'r') as myfile:
    data=myfile.read()
...
class PACS(tfds.core.GeneratorBasedBuilder):
    ...
    def _split_generators(self, dl_manager):
        ...
        # save training domains in different datasets
        ...
        # save all training domains in seperate dataset
        ...
        # get training domains of validation data
        filenames = val_list
