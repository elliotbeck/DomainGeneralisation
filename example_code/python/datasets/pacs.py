...
class PACS(tfds.core.GeneratorBasedBuilder):
    ...
    def _split_generators(self, dl_manager):
        ...
        # TODO: download remaining datasets and fix the filename vars below
        filenames = ['pacs/art_painting_val.hdf5', 'pacs/sketch_val.hdf5',
            'pacs/photo_val.hdf5', 'pacs/cartoon_val.hdf5']
        # filenames = ['pacs/art_painting_train.hdf5', 'pacs/sketch_train.hdf5',
        #     'pacs/photo_train.hdf5', 'pacs/cartoon_train.hdf5']
        ...
        #     'pacs/photo_test.hdf5', 'pacs/cartoon_test.hdf5']
