...
def loss_fn_critic(model_critic, model_generator, features1, features2, config, training):
    ...
    plt.imsave('/cluster/home/ebeck/DomainGeneralisation/DAOT_mnist/images1/fake.png', image_test)
    plt.imsave('/cluster/home/ebeck/DomainGeneralisation/DAOT_mnist/images1/original.png', inputs_test)
    plt.imsave('/cluster/home/ebeck/DomainGeneralisation/DAOT_mnist/images1/peturbation.png', image_test-inputs_test)
    X_generated2 = model_generator(inputs2, training=training)
    X_critic_true1 = model_critic(inputs1, training=training)
    X_critic_true2 = model_critic(inputs2, training=training)
    X_critic_generated1 = model_critic(X_generated1, training=training)  
...
def main():
    ...
    optimizer = tf.keras.optimizers.Adam(learning_rate, epsilon=1e-01)
